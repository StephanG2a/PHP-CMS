            ...
            <nav class="bg-gray-800">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="hidden md:block">
                                    <div class="ml-10 flex items-baseline space-x-4">
                                        ...
                                        <a href="/dashboard/menus" class="rounded-md px-3 py-2 text-sm font-medium <?= $activeTab === 'menus' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>">Menus</a>
                                    </div>
                                </div>
                            </div>
                            <div class="hidden md:block">
                ...
                <div class="border-b border-gray-700 md:hidden hidden" id="mobile-menu">
                    <div class="space-y-1 px-2 py-3 sm:px-3">
                        ...
                        <a href="/dashboard/menus" class="block rounded-md px-3 py-2 text-base font-medium <?= $activeTab === 'menus' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?>">Menus</a>
                    </div>
