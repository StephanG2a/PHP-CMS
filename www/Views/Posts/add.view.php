<form action="/dashboard/posts/store" method="post">
    <div class="space-y-12 sm:space-y-16">
        <div>
            ...
            <p class="mt-1 max-w-2xl text-sm leading-6 text-gray-600">Enter the details for the new post.</p>

            <div class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    <label for="title" class="block text-sm font-medium text-gray-700">Title:</label>
                    <div class="mt-2 sm:col-span-2 sm:mt-0">
                        <input type="text" id="title" name="title" class="border rounded p-2 w-full" required minlength="2">
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    ...
                    <div class="mt-2 sm:col-span-2 sm:mt-0">
                        <textarea id="content" name="content" class="border rounded p-2 w-full" rows="4" required></textarea>
                    </div>
                </div>
