        ...
        <div>
            ...
            <div class="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    <label for="firstname" class="block text-sm font-medium text-gray-700">First Name:</label>
                    <div class="mt-2 sm:col-span-2 sm:mt-0">
                        <input type="text" id="firstname" name="firstname" class="border rounded p-2 w-full" autocomplete="given-name" required minlength="2">
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    <label for="lastname" class="block text-sm font-medium text-gray-700">Last Name:</label>
                    <div class="mt-2 sm:col-span-2 sm:mt-0">
                        <input type="text" id="lastname" name="lastname" class="border rounded p-2 w-full" autocomplete="family-name" required minlength="2">
                    </div>
                </div>
                ...
                <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                    ...
                    <div class="mt-2 sm:col-span-2 sm:mt-0">
                        <input type="email" id="email" name="email" class="border rounded p-2 w-full" autocomplete="email" required>
                    </div>
                </div>
